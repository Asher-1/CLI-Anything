...
The skill manifest enables OpenClaw (and other AI agent platforms) to discover and use the ACloudViewer MCP server with all 178 tools for 3D point cloud and mesh processing.
...
- Full agent integration guide: [ACloudViewer/agent-integration/openclaw/README.md](https://github.com/Asher-1/ACloudViewer/tree/main/agent-integration/openclaw)
- Hub SKILL.md mirror: [skills/cli-anything-acloudviewer/SKILL.md](../../../../skills/cli-anything-acloudviewer/SKILL.md)
- Agent catalog: https://asher-1.github.io/CLI-Anything/SKILL.txt
- MCP Server documentation: [ACLOUDVIEWER.md](../../ACLOUDVIEWER.md)
- Tool reference: [mcp_server.py](mcp_server.py) (`list_tools()` — 178 tools)
