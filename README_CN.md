...
**🌐 [CLI-Hub](https://asher-1.github.io/CLI-Anything/)**：一站式浏览和安装所有社区 CLI。有新软件的 CLI？[提交 PR](https://github.com/Asher-1/CLI-Anything/blob/main/CONTRIBUTING.md) — Hub 会即时更新。
**🌐 [CLI-Hub](https://asher-1.github.io/CLI-Anything/)**：在 **[CLI-Hub](https://asher-1.github.io/CLI-Anything/)** 探索社区已构建的所有 CLI，一条命令即可安装。想贡献你的 CLI？[提交 PR](https://github.com/Asher-1/CLI-Anything/blob/main/CONTRIBUTING.md) — Hub 会即时更新。

<p align="center">
  <a href="#-快速上手"><img src="https://img.shields.io/badge/快速上手-5_分钟-blue?style=for-the-badge" alt="Quick Start"></a>
  <a href="#-实测展示"><img src="https://img.shields.io/badge/Demo-12_款软件-green?style=for-the-badge" alt="Demos"></a>
  <a href="#-测试结果"><img src="https://img.shields.io/badge/测试-1%2C538_通过-brightgreen?style=for-the-badge" alt="Tests"></a>
...
<p align="center">
  ...
  <a href="https://github.com/Asher-1/.github/blob/main/profile/README.md"><img src="https://img.shields.io/badge/飞书-交流群-E9DBFC?style=flat&logo=feishu&logoColor=white" alt="Feishu"></a>
<a href="https://github.com/Asher-1/.github/blob/main/profile/README.md"><img src="https://img.shields.io/badge/微信-交流群-C5EAB4?style=flat&logo=wechat&logoColor=white" alt="WeChat"></a>
</p>
...
| ⚡ "原型和生产之间差十万八千里" | 1,538+ 测试用例，全部在真实软件上验证通过，覆盖 12 款主流应用 |
...
在 12 款复杂应用上进行了实测，涵盖创意、生产力、通信、图表、AI 内容生成和 3D 点云处理领域 —— 这些软件此前对 AI Agent 来说几乎不可触及。
...
<tr>
<td align="center"><strong>🔬 ACloudViewer</strong></td>
<td>3D 点云与网格处理</td>
<td><code>cli-anything-acloudviewer</code></td>
<td>ACloudViewer 二进制 CLI + JSON-RPC</td>
...
> 全部 1,712 项测试 **100% 通过** —— 1,251 项单元测试 + 442 项端到端测试 + 19 项 Node.js 测试。
...
──────────────────────────────────────────────────────────────────────────────
TOTAL        1,712 passed  ✅   100% pass rate
```
...
├── 🔬 acloudviewer/agent-harness/      # ACloudViewer CLI（185 项测试）
...
<sub>为 AI Agent 时代而生 | 12 款专业软件实测 | 1,538 项测试全部通过</sub>
